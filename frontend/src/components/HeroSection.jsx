...
function HeroSection() {
    return (
        <div id='home' className="w-[80%] top-8 left-0 bg-transparent mx-auto h-lscreen">
            <div className="flex flex-col justify-center gap-[20px] w-[60%] top-[60px] h-full">
                ...
                <div className="flex items-center">
                    <a href="/">
                        <button className="bg-[#fff] h-14 w-60 px-4 p-2 text-white font-bold text-[14px] rounded-full self-center hover:font-bold transition-all text-lg duration-200 bg-gradient-to-r from-BASE_YELLOW to-orange">
                            Our Motive ↗
                        </button>
                    </a>
                </div>
